...
void Run(void)
{
					...
					PHA_TEST();
				//rece_date_0 = SPI_Communication_Rece_Cmd_Data(0);	// 读取数据
				//	printf("CH0 _ ->DATA:%d\r\n",rece_date_0);
//				rece_date_1 = SPI_Communication_Rece_Cmd_Data(1);	// 读取数据
//					printf("CH1 _ -> DATA:%d\r\n",rece_date_1);
//				rece_date_2 = SPI_Communication_Rece_Cmd_Data(2);	// 读取数据
//					printf("CH2 -> DATA:%d\r\n",rece_date_2);
//				rece_date_3 = SPI_Communication_Rece_Cmd_Data(3);	// 读取数据
//					printf("CH3 -> DATA:%d\r\n",rece_date_3);
				//	HAL_Delay(500);
//		
